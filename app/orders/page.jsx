...
const OrdersPage = () => {
  ...
  const order100 = ordersData.find((order) => order.order_id === 100);

  console.log("ordersData", ordersData[1]);
  return (
    <>
    ...
    height: 'auto' // Add this if you're using CSS to resize
              ...
              {showFilter && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute left-0 mt-2 w-48 bg-white border-2 shadow-lg rounded-lg py-8 p-4 space-y-3"
                >
                  <div className="absolute right-0 top-1">
                    <button
                      className="px-2 underline text-blue-500 py-2"
                      onClick={() => {
                        setFilters({
                          completed: false,
                          paid: false,
