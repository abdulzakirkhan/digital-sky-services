...
import { getFormattedPriceWith3 } from '@/config/helpers';
...
const Page = () => {
  ...
  const generateMeezanLink =async (amount) => {
   console.log("CALLED")
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await generateMeezanLink(amt);
      console.log("Meezan Bank link generated:", res);
            ...
            <div className="w-full md:col-span-12">
              ...
              <div className="flex w-full justify-center space-y-3 items-center space-x-4 md:space-x-12 mb-4">
                ...
                <motion.button
                  ...
                  className={`bg-primary text-white px-6 mt-2 md:mt-2 ${selectedAmount === "100" && "bg-purple-950"} md:ms-0 py-3 rounded-lg hover:bg-purple-950`}
                ...
                <motion.button
                  ...
                  className={`bg-primary text-white px-6 mt-2 md:mt-2 ${selectedAmount === "200" && "bg-purple-950"} md:ms-0 py-3 rounded-lg hover:bg-purple-950`}
                  whileTap={{ scale: 0.95 }}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.5 }}
                ...
                <motion.button
                  ...
                  className={`bg-primary text-white px-6 mt-2 md:mt-2 ${selectedAmount === "300" && "bg-purple-950"} md:ms-0 py-3 rounded-lg hover:bg-purple-950`}
                  whileTap={{ scale: 0.95 }}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.5 }}
