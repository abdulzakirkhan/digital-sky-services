          ...
          <div className="flex flex-col flex-wrap gap-2">
              ...
              <div className="relative size-24 lg:size-36">
                ...
                >
                  ...
                  <circle
                    ...
                    r="13"
                    fill="none"
                    className={`stroke-current ${Number(order?.completepercentage) === 100 ? "text-[#3BB537]" : Number(order.completepercentage) > 0 ? "text-yellow" : "text-grey"} dark:text-blue-500`}
                    strokeWidth="2.7"
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
                  <span className="text-center text-xl font-bold text-black dark:text-blue-500">
            ...
            <div className="flex justify-start md:justify-between flex-wrap items-center mt-3">
              ...
              <div className="flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  <span
                    className={`p2 ${order?.payment_status === 1 ? "text-green" : "text-red"}`}
                  >
                    Payment Status:
                  </span>
                  <span
                    className={`p3 capitalize ${order?.payment_status === 1 ? "text-green" : "text-red"}`}
                  >
